...
import { analyzeOutlookMessage, completeOutlookConnection, connectOutlook, disconnectOutlookAccount, getOutlookConnectionStatus, getOutlookMessages, resolveAndAnalyzeOutlookMessage } from "../controllers/outlook.controller.js";
...
outlookRouter.post("/messages/resolve-and-analyze", asyncHandler(resolveAndAnalyzeOutlookMessage));
