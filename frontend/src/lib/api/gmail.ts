...
export interface GmailRealtimeAnalysisStatus { enabled: boolean; watchActive: boolean; watchExpiration?: string; historyId?: string; }
...
export function getGmailRealtimeAnalysisStatus() { return apiRequest<GmailRealtimeAnalysisStatus>("/api/v1/gmail/real-time-analysis"); }
export function setGmailRealtimeAnalysis(enabled: boolean) { return apiRequest<GmailRealtimeAnalysisStatus>("/api/v1/gmail/real-time-analysis", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ enabled }) }); }
